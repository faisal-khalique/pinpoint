 ...
 *              'ACTIVEMQ' (ignore case) to use ActiveMQ
 */
public class UseActiveMQForPersistence implements Condition {

	@Override
	public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
		return System.getProperty("persistance.component", "HBASE").equalsIgnoreCase("ACTIVEMQ");
	}
