...
public class ActiveMQActiveTraceDao extends AbstractJacksonSerializer implements AgentStatDaoV2<ActiveTraceBo> {
	...
	@Autowired
	@Qualifier(value = "activeTraceQueue")
	...
	public void insert(String agentId, List<ActiveTraceBo> agentStatDataPoints) {
		...
		String jsonString = serialize(agentStatDataPoints);
		if (jsonString != null) {
