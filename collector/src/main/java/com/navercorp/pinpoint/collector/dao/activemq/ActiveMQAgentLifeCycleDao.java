...
public class ActiveMQAgentLifeCycleDao extends AbstractJacksonSerializer implements AgentLifeCycleDao {
	...
	@Autowired
	@Qualifier(value = "agentLifeCycleQueue")
	...
	public void insert(AgentLifeCycleBo agentLifeCycleBo) {
		...
		String jsonString = serialize(agentLifeCycleBo);
		if (logger.isDebugEnabled()) {
			logger.debug("insert agent life cycle. {}", jsonString);
		}
		if (jsonString != null) {
