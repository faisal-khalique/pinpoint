...
public class ActiveMQDeadlockThreadCountDao extends AbstractJacksonSerializer
		implements AgentStatDaoV2<DeadlockThreadCountBo> {
	...
	@Autowired
	@Qualifier(value = "deadLockThreadQueue")
	...
	public void insert(String agentId, List<DeadlockThreadCountBo> deadlockThreadCountBos) {
		...
		String jsonString = serialize(deadlockThreadCountBos);
		if (jsonString != null) {
