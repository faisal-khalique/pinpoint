...
public class ActiveMQDirectBufferDao extends AbstractJacksonSerializer implements AgentStatDaoV2<DirectBufferBo> {
	...
	@Autowired
	@Qualifier(value = "directBufferQueue")
	...
	public void insert(String agentId, List<DirectBufferBo> directBufferBos) {
		...
		String jsonString = serialize(directBufferBos);
		if (jsonString != null) {
