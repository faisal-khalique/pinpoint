...
public class ActiveMQSqlMetaDataDao extends AbstractJacksonSerializer implements SqlMetaDataDao {
	...
	@Autowired
	@Qualifier(value = "agentSqlMetadataQueue")
	...
	public void insert(SqlMetaDataBo sqlMetaData) {
		...
		String jsonString = serialize(sqlMetaData);
