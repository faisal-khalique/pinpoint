...
public class ActiveMQTransactionDao extends AbstractJacksonSerializer implements AgentStatDaoV2<TransactionBo> {
	...
	@Autowired
	@Qualifier(value = "transactionQueue")
	...
	public void insert(String agentId, List<TransactionBo> transactionBos) {
		...
		String jsonString = serialize(transactionBos);
		if (jsonString != null) {
