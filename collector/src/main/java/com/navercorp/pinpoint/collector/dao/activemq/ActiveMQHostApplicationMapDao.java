...
public class ActiveMQHostApplicationMapDao extends AbstractJacksonSerializer implements HostApplicationMapDao {
	...
	@Autowired
	@Qualifier(value = "agentApplicationMapQueue")
	...
	public void insert(String host, String bindApplicationName, short bindServiceType, String parentApplicationName,
		...
		dataMap.put("bindApplicationName", bindApplicationName);
		dataMap.put("bindServiceType", bindServiceType);
		dataMap.put("parentApplicationName", parentApplicationName);
